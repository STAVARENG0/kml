...
const translations = {
  pt: {
    ...
    ctaText: 'Agendar coleta', instructionsCta: 'Instruções para preparar os itens', finePrint: 'Após enviar o pedido, a equipe KML entrará em contato para confirmar os dados e orientar a preparação dos itens para coleta.',
    ...
    sectionDestination: '4. Destino / destinatário', recipientName: 'Nome do destinatário *', recipientPhone: 'Telefone destino', destinationCountry: 'País destino *', destinationAddress: 'Endereço no destino *', destinationPlaceholder: 'Rua, número, bairro, complemento', destinationCity: 'Cidade destino *', state: 'Estado', notes: 'Observações', notesPlaceholder: 'Melhor horário, referência, instruções...', requiredText: 'Campos marcados com * são obrigatórios.', submitOrder: 'Enviar pedido', sending: 'Enviando...', successTitle: 'Pedido recebido com sucesso', successBody: 'Recebemos seu pedido. Em breve a equipe KML entrará em contato pelo WhatsApp para confirmar a coleta e passar as orientações finais.', successCode: 'Código do pedido:', instructionsButton: 'Ver instruções dos itens', closeMessage: 'Fechar'
  },
  en: {
    ...
    ctaText: 'Schedule pickup', instructionsCta: 'Item preparation instructions', finePrint: 'After submitting your request, the KML team will contact you to confirm the details and guide item preparation for pickup.',
